...
This fork adds support for loading of ELF executables (EXEC type) from their
program (PT_LOAD) segments, in addition to loading of relocatable object
files via ELF section information. This has been specifically tested with
